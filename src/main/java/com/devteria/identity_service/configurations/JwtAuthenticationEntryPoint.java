...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
    // khi 1 request dính lỗi UNAUTHENTICATED thì ta dùng class này để xử lý một cách rõ ràng và thống
    // nhất
    @Override
    public void commence(
        ...
        response
                .getWriter()
                .write(objectMapper.writeValueAsString(apiResponse)); // ghi data vao response
